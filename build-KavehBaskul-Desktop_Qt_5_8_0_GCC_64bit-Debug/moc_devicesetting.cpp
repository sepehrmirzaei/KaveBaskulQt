...
#include "../BaskulDesktop/devicesetting.h"
...
QT_MOC_LITERAL(1, 14, 14), // "NetworkChanged"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 4), // "host"
QT_MOC_LITERAL(4, 35, 4), // "port"
QT_MOC_LITERAL(5, 40, 12), // "CancelDialog"
QT_MOC_LITERAL(6, 53, 12) // "AcceptDialog"

    },
    "DeviceSetting\0NetworkChanged\0\0host\0"
    "port\0CancelDialog\0AcceptDialog"
};
...
void DeviceSetting::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DeviceSetting *_t = static_cast<DeviceSetting *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->NetworkChanged((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< quint16(*)>(_a[2]))); break;
        ...
        {
            typedef void (DeviceSetting::*_t)(QString , quint16 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeviceSetting::NetworkChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject DeviceSetting::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DeviceSetting.data,
      qt_meta_data_DeviceSetting,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DeviceSetting::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DeviceSetting.stringdata0))
        return static_cast<void*>(const_cast< DeviceSetting*>(this));
...
// SIGNAL 0
void DeviceSetting::NetworkChanged(QString _t1, quint16 _t2)
{
